...
- the Credit Governor remains independent of the advisor.
- hard policy violations (fabricated spec-basis, sanctions hit, incomplete
  records) cannot be overridden by human approval.
- disbursing loan funds always escalates to a human -- never automated.
...
- bypassing the Credit Governor's policy checks
